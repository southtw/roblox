...
if not isfolder("risen") then
    makefolder("risen")
end
if not isfolder("risen/"..tostring(game.GameId)) then
    makefolder("risen/"..tostring(game.GameId))
end
--vars
local library,menu,tabholder = loadstring(game:HttpGet("https://raw.githubusercontent.com/southtw/roblox/refs/heads/main/risen/library.lua"))()
...
local risenWatermark = Drawing.new("Text");risenWatermark.Font = Drawing.Fonts.Plex;risenWatermark.Position = Vector2.new(50,24);risenWatermark.Visible = false;risenWatermark.Size = 16;risenWatermark.Color = Color3.new(1,1,1);risenWatermark.Outline = true
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        risenWatermark.Text = "risen | "..ver.." | "..hours..":"..minutes..":"..seconds
    end
end
